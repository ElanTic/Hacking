...
```python
nums= [0x70,0x69,0x63,0x6f,0x43,0x54,0x46,0x7b,0x41,0x53,0x43,
0x49,0x49,0x5f,0x49,0x53,0x5f,0x45,0x41,0x53,0x59,0x5f,0x37,0x42,
0x43,0x44,0x39,0x37,0x31,0x44,0x7d]
for n in nums :
    print(chr(n), end ='')
```

```
jt@jt-VirtualBox:~/Desktop/repos/files/P3$ python3 ascii.py 
